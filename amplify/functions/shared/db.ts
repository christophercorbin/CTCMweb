/**
 * Shared Database Connection Module for Amplify Functions
 * 
 * This module provides a reusable database connection pool for all Amplify Functions.
 * It handles:
 ...
 * Usage:
 * ```typescript
 * import { initializePool, query } from '../shared/db';
 * 
 ...
 * Credentials are cached for Lambda container reuse
 */
...
export async function initializePool(config: DatabaseConfig): Promise<Pool> {
  ...
  pool = new Pool({
    ...
    max: config.maxConnections || 5, // Lower for Amplify Functions
